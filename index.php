...
<div class="w3-bar w3-white w3-large">
  ...
  <a href="#contact" class="w3-bar-item w3-button w3-mobile">Kontakt</a>
	<a href="#contact" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">Registrieren</a>
  <a href="#contact" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">Anmelden</a>
</div>
<!-- Header -->
      ...
      <form action="index.php" method="get" >
        <div class="w3-row-padding" style="margin:0 -16px;">
          ...
          <div class="w3-half">
            ...
            <input class="w3-input w3-border" type="text" placeholder="Bsp. Coblitzalle 9, Mannheim" name="Zielort" required>
          </div>
        </div>
        <div class="w3-row-padding" style="margin:8px -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-male"></i> Abfahrtsdatum</label>
            <input class="w3-input w3-border" type="text" placeholder="DD/MM/JJJ" name="Abfahrtsdatum" required >
          </div>
		<div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-male"></i> Abfahrtszeit</label>
            <input class="w3-input w3-border" type="text" placeholder="hh:00" name="Abfahrtszeit"  required>
          </div>
          <div class="w3-half">
